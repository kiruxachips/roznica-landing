        ...
        <div className="flex-1 min-w-0 max-w-3xl space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Нужны только если хотите получать счёт УПД или перейти на оплату по отсрочке.
              Для обычной работы с предоплатой и скидкой от веса реквизиты не обязательны —
