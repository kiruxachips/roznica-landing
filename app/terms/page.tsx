            ...
            <div className="prose prose-coffee max-w-none">
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
                  ...
                  <li>Стоимость доставки рассчитывается автоматически при оформлении заказа в зависимости от службы доставки, региона и веса посылки. Для некоторых регионов при достаточной сумме заказа доставка может быть бесплатной — итоговая стоимость показывается на странице оформления.</li>
                </ul>
              </section>
