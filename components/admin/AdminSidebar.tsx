...
import { Package, FolderTree, ShoppingCart, MessageSquare, LayoutDashboard, LogOut, Sparkles, Ticket, BookOpen, Truck, Webhook, Boxes } from "lucide-react"
...
const navItems = [
  ...
  { name: "Склад", href: "/admin/warehouse", icon: Boxes },
