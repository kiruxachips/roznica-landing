        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1">
            <h2 className="font-sans text-3xl sm:text-4xl font-bold text-foreground mb-5">
              Кофе того же качества, что в лучших кофейнях страны
            </h2>
            <p className="text-muted-foreground text-base sm:text-lg mb-4 leading-relaxed">
              Millor Coffee — один из крупнейших обжарщиков России и поставщик
              свежеобжаренного кофе для ресторанов, кофеен и розничных сетей по
              всей стране. Свою обжарку, отлаженную для b2b, мы привозим теперь
              и к вам домой — без посредников и складских остатков.
            </p>
            <p className="text-muted-foreground text-base sm:text-lg mb-6 leading-relaxed">
              Каждая партия обжаривается под заказ и отправляется в течение
              суток. Чашка такого кофе дома — это маленькая роскошь на каждый
              день.
            </p>
