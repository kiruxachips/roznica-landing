        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-foreground mb-6">
              Мы знаем толк в кофе
            </h2>
            <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
              Millor Coffee — это команда энтузиастов, которые влюблены в кофе.
              Мы тщательно отбираем зерно напрямую с плантаций, контролируем
              каждый этап обжарки и доставляем вам продукт высочайшего качества.
            </p>
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
              Наша миссия — сделать кофе высочайшего качества доступным для каждого.
              Мы верим, что утро с чашкой свежеобжаренного кофе
              способно изменить весь день к лучшему.
            </p>
