...
export const features = [
  {
    ...
    description: "Обжариваем кофе под каждый заказ. Вы получаете зерно максимальной свежести.",
    icon: "Flame",
  },
  {
    title: "Отборное зерно",
    description: "Работаем напрямую с плантациями. Только арабика премиум-класса.",
    icon: "Award",
  },
  {
    title: "Быстрая доставка",
    description: "Отправляем в день обжарки. Доставка по всей России от 2 дней.",
    icon: "Truck",
  },
  {
