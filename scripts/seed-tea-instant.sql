...
-- 3. Хунань чёрный чай (Чёрный чай — c219e996-ab90-4be9-96d3-21f11d7a92f4)
INSERT INTO "Product" (id, name, slug, description, "fullDescription", "productType", "productForm", "categoryId", badge, "isActive", "isFeatured", "sortOrder", "flavorNotes", "brewingMethods", "createdAt", "updatedAt")
VALUES (
  ...
  E'Мы поставляем чай напрямую с лучших плантаций и гарантируем строгий контроль качества на каждом этапе.\n\nЧёрный чай из провинции Хунань с насыщенным вкусом и богатым ароматом. Идеально подходит для утреннего подъёма или уютного вечернего чаепития.\n\nРасфасовка: 100 г.',
  'tea',
  'листовой',
...
INSERT INTO "ProductImage" (id, "productId", url, alt, "isPrimary", "sortOrder")
VALUES ('i-tea-leafbl-0000-0000-000000000003', 'p-tea-leafbl-0000-0000-000000000003', '/images/tea/hunan.png', 'Хунань — чёрный чай', true, 0);
...
-- 4. Юньнань чёрный чай
INSERT INTO "Product" (id, name, slug, description, "fullDescription", "productType", "productForm", "categoryId", badge, "isActive", "isFeatured", "sortOrder", "flavorNotes", "brewingMethods", "createdAt", "updatedAt")
VALUES (
  'p-tea-lrgbl-00000-0000-000000000004',
  'Юньнань (чёрный чай)',
  'yunnan-chernyy-chay',
  'Чёрный чай из провинции Юньнань — классический дяньхун с мягким насыщенным вкусом. Поставляется напрямую с плантаций.',
  E'Мы поставляем чай напрямую с лучших плантаций и гарантируем строгий контроль качества на каждом этапе.\n\nЧёрный чай из провинции Юньнань (дяньхун) — крупные листья дают мягкий, менее терпкий настой с приятным ароматом и медовыми нотами.\n\nРасфасовка: 100 г.',
  'tea',
  'листовой',
  'c219e996-ab90-4be9-96d3-21f11d7a92f4',
  'Распродажа!',
...
INSERT INTO "ProductImage" (id, "productId", url, alt, "isPrimary", "sortOrder")
VALUES ('i-tea-lrgbl-00000-0000-000000000004', 'p-tea-lrgbl-00000-0000-000000000004', '/images/tea/yunan.png', 'Юньнань — чёрный чай', true, 0);
...
VALUES (
  ...
  E'Премиальный зелёный чай, поставляемый напрямую от производителей с жёстким контролем качества.\n\nЧунь Ми («драгоценные брови») — один из классических китайских зелёных чаёв. Предлагает насыщенный свежий вкус с лёгкой кислинкой и приятной сбалансированной свежестью для ежедневного употребления.\n\nРасфасовка: 100 г.',
  'tea',
  'листовой',
  '1b2ddee2-025f-4107-8752-f1cdf0a746fe',
  'Распродажа!',
